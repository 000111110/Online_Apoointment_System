...
<html lang="en" dir="ltr">
  ...
  <body style="background-image: url('Image/login.jpg');background-repeat: no-repeat;background-size: cover;>
		<div class="container d-flex justify-content-center align-content-center>
			<div style="min-height: 80vh">
				<form class="border shadow p-3 rounded" action="" method="post" style="width:500px">
					...
					<div class="row  mb-3">
						<div class="col col-10">
							...
							<a href="index.php?pg=patients.php&option=add">Signup</a>
						</div>
					</div>
				</form>
			</div>
